...
cd "$REPO"
git add problems/youtube_redesign/output/math2-1_exponential_substitution.mp4 \
        problems/youtube_redesign/output/math2-4_derivative_maxmin.mp4 \
...
git commit -m "rebuild: math2-1/4 を修正後に再生成
