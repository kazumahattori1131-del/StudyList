...
```
【フックになる強い言葉】内容の要約｜数学X・単元名
```

**構成順（固定）：**
1. **フックになる強い言葉**（冒頭15文字以内に「ドキッとするワード」を配置）
2. **内容の要約**（何が学べるか・どんな落とし穴があるか）
3. **数学X・単元名**（検索性のため末尾に置く）

> スマホのサムネイル下テキストは冒頭15文字前後しか見えない。
> 最初の15文字で視聴者が「自分に関係ある」と感じる言葉を必ず入れること。
...
**タイトルのルール：**
- 冒頭15文字以内に「ドキッとするワード」を入れる（「爆死」「全員間違い」「逆転」「0点」など）
...
**フックのパターン例：**
```
○○は使わない！△△だけで瞬殺する｜数学X・単元名
○○すると元に戻る！移項で一発解決｜数学X・単元名
○○を忘れると爆死する！正しい手順を解説｜数学X・単元名
全員間違える○○の落とし穴！正しくは△△｜数学X・単元名
```
