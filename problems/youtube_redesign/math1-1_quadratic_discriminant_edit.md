...
### 動画タイトル
【数学I・判別式】放物線がx軸と2点で交わる条件｜D＞0とD≧0の違いを攻略

### 説明欄
放物線がx軸と「2点で交わる」「接する」「交わらない」場合で、判別式 D の条件がどう変わるかを解説します。D＞0 と D≧0 の混同が最も多い失点パターンです。パラメータ a を含む問題で実際に確認しましょう。
...
### 固定コメント
「放物線がx軸と2点で交わるとき、判別式 D の条件は D＞0 と D≧0 のどちら？ちょっとでも迷ったらこの動画を確認してみてください。」
